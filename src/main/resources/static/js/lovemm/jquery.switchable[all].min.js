var a1326tf = "51la"; var a1326pu = ""; var a1326pf = "51la"; var a1326su = window.location; var a1326sf = document.referrer; var a1326of = ""; var a1326op = ""; var a1326ops = 1; var a1326ot = 1; var a1326d = new Date(); var a1326color = ""; if (navigator.appName == "Netscape") { a1326color = screen.pixelDepth; } else { a1326color = screen.colorDepth; }
try { a1326tf = top.document.referrer; } catch (e) { }
try { a1326pu = window.parent.location; } catch (e) { }
try { a1326pf = window.parent.document.referrer; } catch (e) { }
try { a1326ops = document.cookie.match(new RegExp("(^| )AJSTAT_ok_pages=([^;]*)(;|$)")); a1326ops = (a1326ops == null) ? 1 : (parseInt(unescape((a1326ops)[2])) + 1); var a1326oe = new Date(); a1326oe.setTime(a1326oe.getTime() + 60 * 60 * 1000); document.cookie = "AJSTAT_ok_pages=" + a1326ops + ";path=/;expires=" + a1326oe.toGMTString(); a1326ot = document.cookie.match(new RegExp("(^| )AJSTAT_ok_times=([^;]*)(;|$)")); if (a1326ot == null) { a1326ot = 1; } else { a1326ot = parseInt(unescape((a1326ot)[2])); a1326ot = (a1326ops == 1) ? (a1326ot + 1) : (a1326ot); } a1326oe.setTime(a1326oe.getTime() + 365 * 24 * 60 * 60 * 1000); document.cookie = "AJSTAT_ok_times=" + a1326ot + ";path=/;expires=" + a1326oe.toGMTString(); } catch (e) { }
try { if (document.cookie == "") { a1326ops = -1; a1326ot = -1; } } catch (e) { }
a1326of = a1326sf; if (a1326pf !== "51la") { a1326of = a1326pf; } if (a1326tf !== "51la") { a1326of = a1326tf; } a1326op = a1326pu; try { lainframe } catch (e) { a1326op = a1326su; }
//a1326src = 'http://web2.51.laaaaaa:82/go.asp?svid=7&id=8651326&tpages=' + a1326ops + '&ttimes=' + a1326ot + '&tzone=' + (0 - a1326d.getTimezoneOffset() / 60) + '&tcolor=' + a1326color + '&sSize=' + screen.width + ',' + screen.height + '&referrer=' + escape(a1326of) + '&vpage=' + escape(a1326op) + '&vvtime=' + a1326d.getTime();
//setTimeout('a1326img = new Image;a1326img.src=a1326src;', 0);
/**
 * switchable 1.0
